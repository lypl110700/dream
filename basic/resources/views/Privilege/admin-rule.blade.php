...
@endsection
  <body>
    ...
    <div class="x-body">
      <xblock>
         <a class="layui-btn" href="{{url('ruleAdd')}}" lay-submit="" lay-filter="sreach"><i class="layui-icon"></i>增加</a>
      ...
      <table class="layui-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$v->auth_name}}</td>
            <td class="td-manage">
              <a title="编辑"  href="/ruleEdit?id={{$v->auth_id}}">
                <i class="layui-icon">&#xe642;</i>
              </a>
              <a title="删除"  href="/ruleDel?id={{$v->auth_id}}">
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
          </tr>
